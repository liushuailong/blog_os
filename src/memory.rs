...
use x86_64::{
    structures::paging::{
        PageTable,Page,
        OffsetPageTable, FrameAllocator, Size4KiB, PhysFrame, Mapper, 
    },
    VirtAddr,
    PhysAddr,
};
...
//     translate_add_inner(addr, physical_memory_offset)
// }

// fn translate_add_inner(addr: VirtAddr, physical_memory_offset: VirtAddr) -> Option<PhysAddr> {
